...
st.write("### 🚗 Espandi le tappe e clicca per vedere subito le foto")

# Database con collegamenti fotografici diretti e filtrati
        ...
        "Cape Ose": [
            {
                ...
                "link_foto": "https://google.com",
                "descrizione": "La punta nord-occidentale di Izu. Offre una vista cartolina del Monte Fuji veros il mare. Visita l'antico santuario dei pescatori e il laghetto misterioso di acqua dolce circondato dal mare salato."
            }
        ],
        "Tsumago-juku": [
            {
    ...
    with tabs[i]:
        ...
        for index, tappa in enumerate(tappe):
            with st.expander(tappa["titolo"]):
                ...
                # Nuovo link pulito che apre direttamente il feed di immagini
                st.markdown(f"📸 **[Apri la Galleria Foto di questo Luogo]({tappa['link_foto']})**")
