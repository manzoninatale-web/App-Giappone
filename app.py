...
st.write("### 🚗 Espandi le tappe per vedere le gallerie fotografiche")

# Database con link diretti e stabili alle gallerie fotografiche reali
if "database_viaggio" not in st.session_state:
    st.session_state.database_viaggio = {
        "Izu & Mt. Omuro": [
            {
                "titolo": "🌋 Salita al Monte Omuro",
                "link_foto": "https://wikipedia.org",
        ...
        "Dogashima Trail": [
            {
                ...
                "link_foto": "https://japan-guide.com",
        ...
        "Adachi & Motonosumi": [
            {
                ...
                "link_foto": "https://adachi-museum.or.jp",
    ...
    with tabs[i]:
        ...
        for index, tappa in enumerate(tappe):
            with st.expander(tappa["titolo"]):
                ...
                # Link pulito e specifico
                st.markdown(f"🔗 **[Vedi la Galleria Fotografica Ufficiale]({tappa['link_foto']})**")
